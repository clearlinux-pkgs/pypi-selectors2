...
pushd ..
cp -a selectors2-2.0.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1707140133
...
cp %{_builddir}/selectors2-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-selectors2/c6d9c96ec3c8d23b0044792a060fa7fe6e607b9c || :
